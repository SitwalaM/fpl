...
slim_elements_df.to_csv("../data/main_fpl_gw{}_{}.csv".format(int(gameweek),datestr))
player_variation.to_csv("../data/player_variation_gw{}_{}.csv".format(int(gameweek),datestr))
